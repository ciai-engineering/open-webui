...
export const createNewChat = async (token: string, chat: object) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/new`, {
		method: 'POST',
		headers: {
...
export const getArchivedChatList = async (token: string = '') => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/archived`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllChats = async (token: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/all`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllUserChats = async (token: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/all/db`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllChatTags = async (token: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/tags/all`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatListByTagName = async (token: string = '', tagName: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/tags/tag/${tagName}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatById = async (token: string, id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatByShareId = async (token: string, share_id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/share/${share_id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const shareChatById = async (token: string, id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/${id}/share`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const archiveChatById = async (token: string, id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/${id}/archive`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getTagsById = async (token: string, id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/${id}/tags`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteTagsById = async (token: string, id: string) => {
	...
	const res = await fetchApi(`${WEBUI_API_BASE_URL}/chats/${id}/tags/all`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const submitLeaveForm = async (token: string, formData: object) => {
	let error = null;

	const res = await fetchApi(`${WEBUI_API_BASE_URL}/services/leave`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
